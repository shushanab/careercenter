                    ...
                    <div class="field-body">
                      <div class="field">
                        <p class="control is-expanded has-icons-left">
                          <input class="input is-success" v-model="search" type="search" placeholder="Audience/Profession">
                      ...
                      <div class="field">
                        <p class="control is-expanded has-icons-left">
                          <input class="input is-success" v-model="search"  type="search" placeholder="Company Name">
                          <span class="icon is-small is-left">
                      ...
                      <div class="field">
                        <p class="control is-expanded has-icons-left">
                          <input class="input is-success" v-model="search"  type="search" placeholder="Location">
                          <span class="icon is-small is-left">
                      ...
                      <div class="field">
                        <p class="control is-expanded has-icons-left">
                          <input class="input is-success" v-model="search"  type="search" placeholder="Duration">
                          <span class="icon is-small is-left">
